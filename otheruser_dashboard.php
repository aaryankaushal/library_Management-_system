    ...
    ?>
           <div class="container">
            ...
            <div class="leftinnerdiv">
                <div id="circle">
                <Button id="btn" class="greenbtn" onclick="openpart('myaccount')"> My Account</Button>
                ...
                <div class="submit"><a href="index.php"><Button class="greenbtn" > LOGOUT</Button></a></div>
                </div>
            </div>
            ...
            <p class="mid" ><u>Person Name:</u> &nbsp&nbsp<?php echo $name ?></p>
            <p class="mid" ><u>Person Email:</u> &nbsp&nbsp<?php echo $email ?></p>
            <p class="mid" ><u>Account Type:</u> &nbsp&nbsp<?php echo $type ?></p>
            ...
            foreach($recordset as $row){
                $table.="<tr>";
               "<td>$row[0]</td>";
               $table.="<td><img src='uploads/$row[1]' width='100px' height='140px' style='border:1px solid #333333;'></td>";
               $table.="<td>$row[2]</td>";
                $table.="<td>$row[4]</td>";
                $table.="<td>$row[7]</td>";
